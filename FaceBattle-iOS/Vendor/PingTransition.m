...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    BattleHomeController * fromVC = (BattleHomeController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ChooseBattleModeController *toVC = (ChooseBattleModeController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    UIView *contView = [transitionContext containerView];

    if (![fromVC respondsToSelector:@selector(addNewBattleButton)]) {
        return ;
    }
    
    UIButton *button = fromVC.addNewBattleButton;
