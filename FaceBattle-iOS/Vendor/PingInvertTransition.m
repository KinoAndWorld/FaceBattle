...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    ChooseBattleModeController *fromVC = (ChooseBattleModeController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    BattleHomeController *toVC   = (BattleHomeController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    UIView *containerView = [transitionContext containerView];
    
    if (![toVC respondsToSelector:@selector(addNewBattleButton)]) {
        return ;
    }
    
    UIButton *button = toVC.addNewBattleButton;
